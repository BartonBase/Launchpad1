...
| T-GRAD-03 | The 25% buffer is withdrawn | A locked PDA with no withdraw path (ADR-014). **NOT BUILT; test blocked** | ⛔ blocked |
| T-GRAD-04 | DBC mint substitution (M-03/M-10/M-13) | Verify the DBC-created mint or give DBC a PDA mint (ADR-014, open) | ⛔ not built |
